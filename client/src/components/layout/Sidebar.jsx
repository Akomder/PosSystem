  ...
  const navSections = [
    {
      ...
      items: [
        ...
        { to: '/sell',      icon: ShoppingCart,    label: 'Sell'      },
        ...
        { to: '/cashflow',  icon: BookOpen,        label: 'Cash Flow' },
    ...
    },
    {
      label: 'Inventory',
      items: [
        { to: '/stock-takes',    icon: PackageSearch, label: 'Stock Takes'    },
        { to: '/price-books',    icon: BookMarked,    label: 'Price Books'    },
        { to: '/damage-records', icon: AlertTriangle, label: 'Damage Records' },
      ],
    },
    {
      label: 'Purchasing',
      items: [
        ...
        { to: '/purchase-returns', icon: PackageX,    label: 'Purchase Returns' },
      ],
    },
    {
      label: 'Settings',
      items: [
        ...
        ...(isAdmin ? [{ to: '/audit-log', icon: Shield, label: 'Audit Log' }] : []),
      ],
    },
  ]
